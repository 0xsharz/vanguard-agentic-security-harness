"""Unit tests for the audit.graph public API.
...
Ported from vulnhunter-fix/tests/test_graph_query.py (Task 0.5) with imports
rewritten vulnhunter_fix.graph -> audit.graph. The audit package is
pip-installed editable in .venv, so no sys.path insertion is needed.
"""
